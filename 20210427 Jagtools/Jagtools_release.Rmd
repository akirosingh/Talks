...
varofinterest <- read_excel(here("data","kattria data","Lambda_Variable X Y combi.xlsx"))
...
masterfile <- read_csv("/Volumes/GoogleDrive/Shared drives/Jagannathan Lab/Kattria/Experiments/Lambda study D28 results/R/aimicsclinneut_memCD4.csv")%>%
